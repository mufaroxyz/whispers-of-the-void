...
public class VoidwraithModel extends EntityModel<VoidwraithEntityRenderState> {
    ...
    private final ModelPart voidwraith;
    ...
    public VoidwraithModel(ModelPart root) {
        ...
        this.voidwraith = this.root.getChild("voidwraith");
        this.body = this.voidwraith.getChild("body");
        this.head = this.voidwraith.getChild("head");
    }
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData chest_r1 = upper.addChild("chest_r1", ModelPartBuilder.create().uv(0, 16).cuboid(-7.0F, -14.0F, -1.0F, 8.0F, 14.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(-1.0F, 0.0F, -3.0F, 0.0F, 1.5708F, 0.0F));

        ModelPartData lower = body.addChild("lower", ModelPartBuilder.create().uv(32, 0).cuboid(0.0F, -10.0F, -4.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r3 = dongle.addChild("cube_r3", ModelPartBuilder.create().uv(16, 34).cuboid(-3.0F, -3.0F, 0.0F, 1.0F, 3.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 4.7302F, -3.8658F, -0.4363F, 0.0F, 0.0F));
        ...
        ModelPartData cube_r6 = dongle2.addChild("cube_r6", ModelPartBuilder.create().uv(20, 34).cuboid(-3.0F, -3.0F, 0.0F, 1.0F, 3.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 4.7302F, -3.8658F, -0.4363F, 0.0F, 0.0F));
